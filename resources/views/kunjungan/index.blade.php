...
<head>
    ...
    <div class="header" align='center'>
      ...
      <br>
         ...
         <a href="{{ route('kunjungan.create') }}" class='btn btn-success'>Tambah Data</a> <a href="" class='btn btn-danger'>Logout</a>
                    ...
                    @foreach ($data as $item)
                        <tr>  
                            ...
                            <td>
                                ...
                                <a href="{{ url('kunjungan/edit', $item->id) }}" class="btn btn-info">Edit</a>
                    ...
                    @endforeach
                        ...
                        <a href="/kunjungan/cetak_pdf" class="btn btn-danger" target="_blank">CETAK PDF</a>
